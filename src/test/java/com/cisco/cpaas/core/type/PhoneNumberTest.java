...
class PhoneNumberTest {
  ...
  public void shouldAcceptE164PhoneNumbers(String number) {
    assertThat(PhoneNumber.of(number).get(), is(number));
  }
  ...
  public void shouldNotAcceptInvalidE164PhoneNumbers(String number) {
    IllegalArgumentException e =
        assertThrows(IllegalArgumentException.class, () -> PhoneNumber.of(number));
  ...
  public void shouldHandleNullInput() {
    NullPointerException e = assertThrows(NullPointerException.class, () -> PhoneNumber.of(null));
